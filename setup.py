...
setup(
  name='kivyhost',         # How you named your package folder (MyLib)
  packages=['kivyhost'],   # Chose the same as "name"
  version='0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description='Helps you view kivy app logs on android platform without adb',   # Give a short description about your library
